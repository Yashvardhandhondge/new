...
export async function PUT(
  ...
  try {
    ...
    const tree = await Tree.TreeModal.findOneAndUpdate(
...
export async function DELETE(
  ...
  try {
    ...
    await db.connect();
    const tree = await Tree.TreeModal.findOneAndDelete({ _id: params.id, userId });
...
export async function GET(
  ...
  try {
    ...
    await db.connect();
    const tree = await Tree.TreeModal.findOne({ _id: params.id, userId });
